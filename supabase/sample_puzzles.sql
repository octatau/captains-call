...
-- Puzzle 1: Top 10 Tech Companies by Market Cap (Jan 2024)
...
-- Puzzle 2: Most Popular Programming Languages (GitHub Stars 2024)
INSERT INTO puzzles (puzzle_number, daily_date, prompt, items, true_rankings, sources, published_at)
VALUES (
    2,
...
-- Puzzle 3: Highest Grossing Movies of All Time (Worldwide Box Office)
INSERT INTO puzzles (puzzle_number, daily_date, prompt, items, true_rankings, sources, published_at)
VALUES (
    3,
...
-- Puzzle 4: Most Populated Countries (2024)
INSERT INTO puzzles (puzzle_number, daily_date, prompt, items, true_rankings, sources, published_at)
VALUES (
    4,
...
-- Puzzle 6: Most Visited Countries by International Tourists (2023)
INSERT INTO puzzles (puzzle_number, daily_date, prompt, items, true_rankings, sources, published_at)
VALUES (
    6,
...
-- Puzzle 7: Largest Companies by Revenue (Fortune Global 500, 2023)
INSERT INTO puzzles (puzzle_number, daily_date, prompt, items, true_rankings, sources, published_at)
VALUES (
    7,
